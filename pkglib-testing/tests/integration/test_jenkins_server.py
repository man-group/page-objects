...
requires_jenkins = mark.skipif(not (os.path.isfile(CONFIG.jenkins_war) and
                                    os.path.isfile(CONFIG.java_executable)),
                               reason="Can't find jenkins_war or java_executable")
